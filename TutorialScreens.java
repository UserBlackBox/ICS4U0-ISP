...
//    	sketch.textAlign(sketch.CENTER);
//    	sketch.rectMode(PApplet.CENTER);
//    	sketch.text("You are a virus, your goal in the game is to infect everybody. This short tutorial will just teach you the basics of being a virus."+
//    			" When you enter the tutorial you will find yourself by finding the X",550, 400, 500, 500);
//    	sketch.textFont(font18, 18); //prompt
//    	sketch.text("Click anywhere to exit", 550, 890);
//    	sketch.pushMatrix(); //lower left image
//    	sketch.translate(-20,500);
